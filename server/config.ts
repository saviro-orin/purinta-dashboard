...
const envSchema = z.object({
  ...
  ETHEREUM_RPC_URL: z.string().url().default('https://eth-mainnet.public.blastapi.io'),
  ETHEREUM_RPC_FALLBACK_URL: optionalUrl.default('https://eth.drpc.org'),
  ...
  PURINTA_INDEXER_DELAY_MS: z.coerce.number().int().nonnegative().default(750),
